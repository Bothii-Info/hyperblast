                  ...
                  <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-start justify-between mb-3">
                        ...
                        <div
                          className={`flex items-center gap-1 px-2 py-1 rounded-full text-xs font-medium ${getStatusColor(lobby.status)}`}
                        >
                      ...
                      <div className="flex flex-wrap items-center gap-4 md:gap-6">
                        ...
                        <div className="flex items-center gap-2 text-[#b7b4bb]">
                          ...
                          <span className="text-sm md:text-base">Lobby {lobby.id.split("-")[2]}</span>
                        </div>
                    ...
                    <div className="lg:ml-6">
                      ...
                      >
                        <Eye size={18} />
                        <span>{lobby.status === "Waiting" ? "Waiting for Players" : "Spectate Match"}</span>
                      </button>
                    </div>
                  </div>
                </div>
