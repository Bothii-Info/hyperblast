import { Crown, Trophy, Medal, Award, Target, Zap, TrendingUp } from "lucide-react"

/**
 * Enhanced leaderboard component with detailed laser tag stats
 */
function Leaderboard({ players, className = "", showDetailedStats = false }) {
          ...
          >
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-right ml-2 md:ml-4 flex-shrink-0">
                ...
                {showDetailedStats && player.streak > 5 && (
                  <div className="flex items-center justify-end gap-1 text-[#e971ff] text-xs mt-1">
